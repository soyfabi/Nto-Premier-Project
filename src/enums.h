...
enum CombatType_t : uint16_t {
	...
	COMBAT_RAITONDAMAGE = 1 << 1,
	COMBAT_DOTONDAMAGE = 1 << 2,
	COMBAT_KATONDAMAGE = 1 << 3,
	COMBAT_UNDEFINEDDAMAGE = 1 << 4,
	COMBAT_LIFEDRAIN = 1 << 5,
	COMBAT_MANADRAIN = 1 << 6,
	COMBAT_HEALING = 1 << 7,
	COMBAT_DROWNDAMAGE = 1 << 8,
	COMBAT_HYOTONDAMAGE = 1 << 9,
	COMBAT_FUUTONDAMAGE = 1 << 10,
	COMBAT_SUITONDAMAGE = 1 << 11,
...
enum CombatParam_t {
	...
	COMBAT_PARAM_DISABLECREATUREEVENT,
};
...
enum ConditionType_t {
	...
	CONDITION_ROOTED = 1 << 23,
	CONDITION_EXHAUST_COMBAT = 1 << 24, // unused
	CONDITION_EXHAUST_HEAL = 1 << 25, // unused
	CONDITION_PACIFIED = 1 << 26,
