...
ShootTypeNames shootTypeNames = {
	{"shuriken",		CONST_ANI_SHURIKEN},
	{"senbon",		CONST_ANI_SENBON},
	{"bigshuriken",		CONST_ANI_BIGSHURIKEN},
	{"senbonfive",		CONST_ANI_SENBONFIVE},
	{"scythe",		CONST_ANI_SCYTHE},
	{"explosivepaper",		CONST_ANI_EXPLOSIVEPAPER},
	{"kunai",		CONST_ANI_KUNAI},
...
std::string getSkillName(uint8_t skillid)
{
	switch (skillid) {
		...
		case SKILL_SWORD:
			return "kenjutsu fighting";

		case SKILL_AXE:
			return "taijutsu fighting";

		case SKILL_DISTANCE:
			return "throwing fighting";
...
std::string getWeaponName(WeaponType_t weaponType)
{
	switch (weaponType) {
		...
		case WEAPON_AXE: return "taijutsu";
...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_NOTENOUGHMANA:
			return "You don't have enough chakra.";
