...
void Creature::onTickCondition(ConditionType_t type, bool& bRemove)
{
	...
	switch (type) {
		case CONDITION_KATON:
			bRemove = (field->getCombatType() != COMBAT_KATONDAMAGE);
			break;
		case CONDITION_RAITON:
			bRemove = (field->getCombatType() != COMBAT_RAITONDAMAGE);
			break;
		case CONDITION_POISON:
			bRemove = (field->getCombatType() != COMBAT_DOTONDAMAGE);
			break;
		case CONDITION_FREEZING:
			bRemove = (field->getCombatType() != COMBAT_HYOTONDAMAGE);
			break;
		case CONDITION_DAZZLED:
			bRemove = (field->getCombatType() != COMBAT_FUUTONDAMAGE);
			break;
		case CONDITION_CURSED:
			bRemove = (field->getCombatType() != COMBAT_SUITONDAMAGE);
			break;
