...
function spell.onCastSpell(creature, variant)
    ...
    local distanceMessage = "\nin [" .. maxPositionDifference .. " SQM] away"
    ...
    creature:sendTextMessage(MESSAGE_INFO_DESCR, target:getName() .. " " .. message .. " " .. distanceMessage .. ".")
    creaturePosition:sendMagicEffect(5)
    return true
end

spell:words("Sennin Sense")
spell:group("support")
spell:id(1)
