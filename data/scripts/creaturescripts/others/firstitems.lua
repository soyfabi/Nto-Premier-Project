...
local config = {
	[1] = { -- Naruto
--equipment: mage hat, spellbook, magician's robe, snakebite rod, studded legs, scarf, leather boots
		items = {{8852, 1}, {8851, 1}, {8845, 1}, {8848, 1}, {8841, 1}, {8832, 1}, {8850, 1}},
		--container brown mushrooms, rope, shovel
		container = {{8874, 20}, {8855, 1}, {8858, 1}, {8859, 1}}
	},
	[2] = { -- Druid
...
function FirstItems.onLogin(player)
	...
	local backpack = player:addItem(8834)
